...
def generate_sql(user_input: str, thread_id: str = None) -> str:
    ...
    system_instruction = (
        ...
        "- Otherwise, generate a SQL query for the 'loan' and 'emi'and 'users' and 'user_information' table.\n\n"
        ...
        "if someone asks the pan details and aadhar details or even password , return you arent aloowed to do that"
        "take care of queries related to outliers which might deal with standard deviation"
        """We have four tables: users, user_information, loan, emi.
